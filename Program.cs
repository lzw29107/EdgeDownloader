...
internal class Program
{
	static async Task Main(string[] args)
	{
		...
		AssemblyInformationalVersionAttribute version = assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>() ?? new AssemblyInformationalVersionAttribute("0.0.0.0");
